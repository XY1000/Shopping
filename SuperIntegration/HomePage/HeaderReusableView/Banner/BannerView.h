...
//首页调用
@property (assign, nonatomic) CGRect nowFrame;
@property (strong, nonatomic) NSArray<NSString *> *imageUrls;
//产品详情调用
@property (strong, nonatomic) NSArray<NSString *> *ProductDetailPage_ImageUrls;
//回调第几张图片
@property (copy, nonatomic) void(^currentImageIndexBlock)(NSInteger index);//index从1开始
